...
const packlist = {
    desciption: "Packlist is a backpacking preparation web application. It utilizes geolocation and real time weather data to tailor a list of recommended items/gear/equipment to a user based on the near future environment of their trip location.",
    features: [
...
const Projects = () => {
	return (
		<div className='bg-sky-800 m-10 flex flex-col items-center'>
			<h1 className='text-white font-bold text-8xl mb-10'>Projects</h1>
			<div className="flex justify-center">
				<ProjectCard name='fitly' link={"https://fitly-frontend.onrender.com"} imageSrc={"fitlyHomepage.png"}  description={fitly.desciption} stack={fitly.stack}/>
				<ProjectCard name='packlist' link={"https://packlist-w8xx.onrender.com"} imageSrc={`packlistHomepage.png`} description={packlist.desciption} stack={packlist.stack} />
			</div>
		</div>
	);
};
