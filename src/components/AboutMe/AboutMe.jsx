			...
			<div className="descriptions">
				<h3 className='subheader-content'>About</h3>
					<p className="section-content">
						I'm a developer, passionate about solving the next problem. I thrive in <span>collaborative</span> environments that
						foster <span>innovative</span>, outside of the box thinking.
					</p>

					<p className="section-content">
						I'm currently working as a <span>Software Developer</span> at Brinkley RV, specializing in <span>ERP Development</span>. My
						contributions include custom scripting for additional NetSuite functionality and building/integrating Vue.js
						applications into Netsuite.
					</p>

					<p className="section-content">
						My experience prior to Software Engineering was in Construction Management, where I was able to foster the
						skills that are hard to teach, such as <span>Time Managment</span>, <span>Communication</span>, and <span>Task Prioritization</span>.
					</p>
